/*import MyTravelAdaterPlugin from "../../../../resources/admin/js/ckeditor/uploadAdapter";*/
...
jQuery(function ($) {
    ...
    $('.upload-btn-wrapper').each(function () {
        ...
        $(document).on('change', '.btn-file :file', function (event) {
            ...
            if(input.data('value') != null && input.data('value') == info){
                avatar = 1;
            }
                    ...
                    uploaderModal.show({
                        ...
                        onSelect:function (files) {
                            ...
                            if(files.length)
                                ...
                                callback(myTravel.url+'/media/preview/'+files[0].id);
...
var vendorPayout = {
    ...
    saveAccounts:function (btn) {
        ...
        $.ajax({
            ...
            url:myTravel.url+'/vendor/storePayoutAccounts',
            ...
            success:function (json) {
                ...
                if(json.message){
                    ...
                    myTravelApp.showSuccess(json.message);
    ...
    sendRequest:function (btn) {
        ...
        $.ajax({
            ...
            url:myTravel.url+'/vendor/createPayoutRequest',
