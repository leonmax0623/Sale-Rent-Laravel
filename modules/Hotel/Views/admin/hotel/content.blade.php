<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{!! clean($translation->title) !!}" placeholder="{{__("Write the Name of Your Property ")}}" name="title" class="form-control @if($errors->has('title')) is-invalid @endif">
        </div>
        <div class="form-group">
