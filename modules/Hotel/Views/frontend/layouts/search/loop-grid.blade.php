...
@endphp
<div class="card transition-3d-hover shadow-hover-2 vache mt-2 item-loop {{$wrap_class ?? ''}}">
    <div class="position-relative">
        <div class="product-item__slider product-item__slider-maps u-slick">
            <a href="{{$row->getDetailUrl(false)}}" class="d-block gradient-overlay-half-bg-gradient-v5 js-slide">
                @if($row->image_url)
