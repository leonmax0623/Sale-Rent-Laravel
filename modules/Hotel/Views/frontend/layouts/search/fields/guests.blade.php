<div class="item">
    <div class="main_search_wrap main_search_input-block  col dropdown-custom px-0 mb-4 form-select-guests">
        ...
        <div class="flex-horizontal-center d-flex  dropdown-toggle" data-toggle="dropdown">
            ...
            @endphp
            <div class="scroll_body main_search_input text-black font-size-16 font-weight-semi-bold mr-auto" style="line-height:36px;font-size:16px!important;">
               <div class="render d-none" style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                ...
                <div class="show-block d-block scroll_body">
                    <span>{{ __('Select Guests') }}</span>
                </div>
            </div>
        </div>
