            ...
            <div class="col-md-5 col-xl-4">
                <div class="product-item__header">
                    <div class="position-relative">
                        <div class="product-item__slider travel-slick-carousel u-slick"
                             data-arrows-classes="slick-arrow"
                             data-arrow-left-classes="slick-prev"
                             data-arrow-right-classes="slick-next"
                             data-pagi-classes="slick-dots"
                             data-infinite="true"
                             data-dots="true"
                             data-arrows="true">
                            <a href="{{$row->getDetailUrl()}}" class="d-block js-slide">
