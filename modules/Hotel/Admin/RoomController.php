        ...
        $data = [
            ...
            'breadcrumbs'        => [
                ...
                [
                    ...
                    'url'  => 'admin/module/property-hotels/edit/'.$this->currentHotel->id
                ],
                [
    ...
    public function edit(Request $request, $hotel_id,$id)
    {
        ...
        $data = [
            ...
            'breadcrumbs'    => [
                ...
                [
                    'name' => __('All Rooms'),
                    'url'  => 'admin/module/property-hotels/room/'.$this->currentHotel->id.'/index'
                ],
                [
                    'name' => __('Edit room: :name',['name'=>$row->title]),
                    'url'  => 'admin/module/property-hotels/room/'.$this->currentHotel->id.'/edit/'.$id
                ],
            ],
