...
use Modules\Sale\Models\SaleDate;
...
class AvailabilityController extends FrontendController
{
    ...
    protected $indexView = 'Sale::frontend.user.availability';
    ...
    public function index(Request $request){
        ...
        $page_title = __('Sales Availability');
    ...
    public function loadDates(Request $request){
        ...
        if(empty($space)){
            return $this->sendError(__('Sale not found'));
        }
