...
class FormSearchSpace extends BaseBlock
{
    ...
    {
        return __('Sale: Form Search');
    }

    public function content($model = [])
    {
        $limit_location = 15;
        if( empty(setting_item("property_sale_location_search_style")) or setting_item("property_sale_location_search_style") == "normal" ){
            $limit_location = 1000;
        }
        $data = [
        ...
        return view('Sale::frontend.blocks.form-search-space.index', $data);
    }
