...
@section('content')
    <form action="{{route('sale.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
        @csrf
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    @if($row->uid)
                        {{--<p class="item-url-demo">{{__("Permalink")}}: {{ url('property-sale' ) }}/<a href="#" class="open-edit-input" data-name="slug">{{$row->slug}}</a></p>--}}
                        <p class="item-url-demo">{{__("Permalink")}}: {{$row->getDetailUrl(request()->query('lang'))}}</p>
                    @endif
                </div>
                <div class="">
                    @if($row->uid)
                        <a class="btn btn-primary btn-sm" href="{{$row->getDetailUrl(request()->query('lang'))}}" target="_blank">{{__("View Sale")}}</a>
                    @endif
                </div>
            </div>
            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        @include('Sale::admin.space.content')
                        @include('Sale::admin.space.pricing')
                        @if(is_default_lang())
                        @endif
                        @include('Sale::admin.space.location')
                    ...
                    <div class="col-md-3">
                        ...
                        @if(is_default_lang())
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label>{{__('Property Sale Featured')}}</label>
                                        <br>
                                        <label>
                            ...
                            @include('Sale::admin.space.attributes')
                            <div class="panel">
