...
@section('content')
    ...
    <div class="d-flex justify-content-between mb20">
        <div class="">
            <h2 class="title-bar no-border-bottom">{{$row->id ? __('Edit: ').$row->title : __('Add new Sale')}}</h2>
            @if($row->uid)
    ...
    <div class="lang-content-box">
        <form action="{{route('sale.vendor.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
            @csrf
            <div class="form-add-service">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-tour-location">
                        @include('Sale::admin/space/location',["is_smart_search"=>"1"])
