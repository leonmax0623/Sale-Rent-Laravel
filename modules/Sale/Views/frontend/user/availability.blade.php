...
@section ('content')
    ...
    @else
        <div class="alert alert-warning">{{__("No sales found")}}</div>
    @endif
    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
			...
			calendar = new FullCalendar.Calendar(calendarEl, {
				...
				events:{
                    	url:"{{route('sale.vendor.availability.loadDates')}}",
						extraParams:{
							id:lastId,
                        }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'{{route('sale.vendor.availability.store')}}',
                        data:this.form,
                        dataType:'json',
                        method:'post',
