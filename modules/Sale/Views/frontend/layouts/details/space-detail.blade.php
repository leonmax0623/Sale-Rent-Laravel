...
@endif
@include('Sale::frontend.layouts.details.space-attributes')
@include('Sale::frontend.layouts.details.space-faqs')
...
@endif
@include('Sale::frontend.layouts.details.space-video')
