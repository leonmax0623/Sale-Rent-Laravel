...
class CreateSaleTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bc_sales', function (Blueprint $table) {
        ...
        Schema::create('bc_sale_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_sale_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_sale_dates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bc_sales');
        Schema::dropIfExists('bc_sale_translations');
        Schema::dropIfExists('bc_sale_term');
        Schema::dropIfExists('bc_sale_dates');
    }
}
