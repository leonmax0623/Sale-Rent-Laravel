...
class SaleController extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->space = Sale::class;
        $this->space_translation = SaleTranslation::class;
        $this->space_term = SaleTerm::class;
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'=>__("Property Sale Management")
        ];
        return view('Sale::admin.index', $data);
    }
    ...
    public function recovery(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'=>__("Recovery Property Sale Management")
        ];
        return view('Sale::admin.index', $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        $data = [
            ...
            'breadcrumbs'    => [
                ...
                [
                    'name'  => __('Add Property Sale'),
                    'class' => 'active'
                ],
            ],
            'page_title'     => __("Add new Property Sale")
        ];
        return view('Sale::admin.detail', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (empty($row)) {
            return redirect(route('property-sale.admin.index'));
        }
    ...
    public function store( Request $request, $id )
    {
        ...
        if($id>0){
            ...
            $row = $this->space::find($id);
            if (empty($row)) {
                return redirect(route('sale.admin.index'));
            }
        ...
        if ($res) {
            ...
            if($id > 0 ){
                ...
                return back()->with('success',  __('Property Sale updated') );
            }else{
                ...
                return redirect(route('sale.admin.edit',$row->id))->with('success', __('Sale created') );
            }
        }
    }
