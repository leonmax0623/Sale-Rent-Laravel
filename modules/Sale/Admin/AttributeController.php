...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'property-sale');
        ...
        return view('Sale::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('Sale::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Sale::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/property-sale/attribute/terms/' . $row->attr_id
                ],
                [
        ...
        return view('Sale::admin.terms.detail', $data);
    }
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('sale');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('sale',$q);
