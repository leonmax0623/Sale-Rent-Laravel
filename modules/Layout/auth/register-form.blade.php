<form class="form bravo-form-register" method="post">
    @csrf
    {{--<input id="register_phone_code" type="hidden" name="phone_code">--}}
    <input id="register_phone_country" type="hidden" name="phone_country">
    <div class="row">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-12">
            <div class="form-group">
                <input id="register_phone_code" type="text" class="form-control" name="phone_code" autocomplete="off" placeholder="">
                <span class="invalid-feedback error error-phone_code"></span>
            </div>
        </div>
        <div class="col-lg-8 col-md-12">
            <div class="form-group">
                <input id="register_phone" type="text" class="form-control" name="phone" autocomplete="off" placeholder="{{__('Phone')}}">
