...
<div class="header-logo flex-shrink-0">
    ...
    <h3 class="logo-text"><a href="{{url('/admin')}}">
            {{--{{__('My Travel')}} <span class="app-version">{{config('app.version')}}</span>--}}
            <img src="https://images.tesldproject.com/uploads/0000/1/2022/01/26/logss.png" alt="Travel System">
        </a></h3>
...
<div class="header-widgets d-flex flex-grow-1">
    ...
    <div class="widgets-left d-flex flex-grow-1 align-items-center">
        ...
        <div class="header-widget">
            ...
            <span class="btn-toggle-admin-menu btn btn-sm btn-link"><i class="fa fa-angle-left "></i></span>

        </div>

        <div class="header-widget search-widget ml-2">

            <a href="{{url('/')}}" class="btn btn-link" target="_blank">{{__('Home Page')}}
    ...
    <div class="widgets-right flex-shrink-0 d-flex">
        ...
        <div class="dropdown header-widget widget-user  dropdown-notifications flex-shrink-0" style="min-width: 0">
