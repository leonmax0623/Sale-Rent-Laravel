        ...
        <div class="row">
            <div class="col-12 col-lg-5">
                ...
                <form class="form bravo-form-register-vendor" method="post" action="{{route('vendor.register')}}">
                    @csrf
                    {{--<input id="vendor_register_phone_code" type="hidden" name="phone_code">--}}
                    <input id="vendor_register_phone_country" type="hidden" name="phone_country">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12">
                            <div class="form-group">
                                <input id="vendor_register_phone_code" type="text" class="form-control" name="phone_code" autocomplete="off" placeholder="">
                                <span class="invalid-feedback error error-phone_code"></span>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-12">
                            <div class="form-group">
                                <input id="vendor_register_phone" type="text" class="form-control" name="phone" autocomplete="off" placeholder="{{__('Phone')}}">
                                <span class="invalid-feedback error error-phone error-phone_without_code"></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
