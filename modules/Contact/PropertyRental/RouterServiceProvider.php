...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\PropertyRental\Controllers';

    protected $adminModuleNamespace = 'Modules\PropertyRental\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware(['web','dashboard'])
            ...
            ->prefix('admin/module/property-rental')
