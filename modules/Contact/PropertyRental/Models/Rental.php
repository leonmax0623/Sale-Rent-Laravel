...
class Rental extends Bookable
{
    ...
    public $type = 'rental';
    public $checkout_booking_detail_file       = 'PropertyRental::frontend/booking/detail';
    public $checkout_booking_detail_modal_file = 'PropertyRental::frontend/booking/detail-modal';
    public $set_paid_modal_file                = 'PropertyRental::frontend/booking/set-paid-modal';
    public $email_new_booking_file             = 'PropertyRental::emails.new_booking_detail';
    ...
    public function getDetailUrl($include_param = true)
    {
        ...
        $urlDetail = app_get_locale(false, false, '/') . config('space.rental_route_prefix') . "/" . $this->slug;
        if(!empty($param)){
    ...
    {
        return "\Modules\PropertyRental\Controllers\AvailabilityController";
    }
