<div class="panel">
    ...
    <div class="panel-body">
                ...
                <div class="">
                    <select name="property_type" class="form-control">
                        ...
                        @foreach($types as $type)
                            <option value="{{ $type->term->id }}">{{ $type->term->name }}</option>
                        @endforeach
                        @endif
                    </select>
                </div>
        ...
        <div class="form-group">
            ...
            <input type="text" value="{!! clean($translation->title) !!}" placeholder="{{__("Write the Name of Your Property ")}}" name="title" class="form-control">
        </div>
        <div class="form-group">
