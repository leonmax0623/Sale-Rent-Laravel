        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    @if($row->slug)
                        <p class="item-url-demo">{{__("Permalink")}}: {{ url('property-rental' ) }}/<a href="#" class="open-edit-input" data-name="slug">{{$row->slug}}</a>
                        </p>
                    @endif
                </div>
                <div class="">
            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        @include('PropertyRental::admin.space.content')
                        @include('PropertyRental::admin.space.pricing')
                        @if(is_default_lang())
                        @endif
                        @include('PropertyRental::admin.space.location')
                    ...
                    <div class="col-md-3">
                        ...
                        @if(is_default_lang())
                            ...
                            @include('PropertyRental::admin.space.attributes')
                            <div class="panel">
                            ...
                            @include('PropertyRental::admin/space/ical')
                        @endif
                    </div>
                </div>
            </div>
