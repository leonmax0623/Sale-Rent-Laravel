...
class SpaceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($list)) {
            foreach ($list as $row) {
                $markers[] = [
                    ...
                    "infobox" => view('PropertyRental::frontend.layouts.search.loop-grid', ['row' => $row,'disable_lazyload'=>1,'wrap_class'=>'infobox-item'])->render(),
        ...
        if ($is_ajax) {
            return $this->sendSuccess([
                'html'    => view('PropertyRental::frontend.layouts.search-map.list-item', $data)->render(),
        ...
        if ($layout == "map") {
            ...
            return view('PropertyRental::frontend.search-map', $data);
        }
        return view('PropertyRental::frontend.search', $data);
    }
    ...
    public function detail(Request $request, $slug)
    {
        ...
        return view('PropertyRental::frontend.detail', $data);
    }
}
