...
use Modules\PropertyRental\Models\RentalDate;
...
class AvailabilityController extends FrontendController{
    ...
    protected $indexView = 'PropertyRental::frontend.user.availability';
    ...
    public function index(Request $request){
        ...
        $page_title = __('Property Rentals Availability');
    ...
    public function loadDates(Request $request){
        ...
        if(empty($space)){
            return $this->sendError(__('Rental not found'));
        }
