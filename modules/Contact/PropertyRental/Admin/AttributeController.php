...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'property-rental');
        ...
        return view('PropertyRental::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('PropertyRental::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('PropertyRental::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/property-rental/attribute/terms/' . $row->attr_id
                ],
                [
        ...
        return view('PropertyRental::admin.terms.detail', $data);
    }
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('rental');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('rental',$q);
