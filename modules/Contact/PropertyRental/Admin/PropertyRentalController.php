...
class PropertyRentalController extends AdminController
{
    protected $space;
    ...
    public function index(Request $request)
    {
        ...
        return view('PropertyRental::admin.index', $data);
    }
    ...
    {
        $attId = 24;
        $values = RentalTerm::query()->with('term', function($query) use($attId) {
            $query->where('attr_id', $attId);
        })->whereHas('term', function ($query) use($attId) {
            $query->where('attr_id', $attId);
        ...
        return view('PropertyRental::admin.detail', $data);
    }
