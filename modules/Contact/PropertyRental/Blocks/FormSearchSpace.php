...
class FormSearchSpace extends BaseBlock
{
    ...
    {
        return __('Rental: Form Search');
    }

    public function content($model = [])
    {
        $limit_location = 15;
        if( empty(setting_item("property_rental_location_search_style")) or setting_item("property_rental_location_search_style") == "normal" ){
            $limit_location = 1000;
        }
        $data = [
        ...
        return view('PropertyRental::frontend.blocks.form-search-space.index', $data);
    }
