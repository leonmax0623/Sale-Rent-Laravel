<div class="form-checkout" id="form-checkout">
    ...
    <input id="booking_phone_country" type="hidden" name="phone_country" value="{{$user->phone_country ?? ''}}">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input id="booking_phone_code" type="text" value="" name="hidden_phone_code" placeholder="{{__("Your Phone Code")}}" class="form-control">
                                <input type="hidden" value="{{$user->phone_code ?? ''}}" name="phone_code" placeholder="{{__("Your Phone Code")}}" class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="form-group">
                                <label class="form-label">{{__("Phone")}}</label>
                                <input type="text" value="{{$user->phone ?? ''}}" name="phone" placeholder="{{__("Your Phone")}}" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
