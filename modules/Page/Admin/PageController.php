...

{
...

    {
        ...
        $data = [
            ...
            'page_title'=>__("Directory Management"),
    ...
    public function store(Request $request, $id)
    {
        ...
        if($request->input('slug_page_name')){
            $row->slug_page_name = $request->input('slug_page_name');
        }
        ...
        if($id > 0 ){
            ...
            return back()->with('success',  __('Directory updated') );

        }else{

            return redirect()->route('page.admin.edit',['id'=>$row->id])->with('success', $id > 0 ?  __('Directory updated') : __('Directory created'));
