...

{
    ...
    protected $slugFieldName = 'slug_page_name';
    protected $slugFromFieldName = 'title_page_name';
...

    {
        ...
        return route('page.detail',['slugPageName' =>$this->slug_page_name, 'slug'=>$this->slug]);
