        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-between mb20">
                ...
                <div class="">
                    ...
                    <h1 class="title-bar">{{$row->id ? __('Edit: ') .$translation->title :  __('Add new directory') }}</h1>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-title">
                                ...
                                <strong>{{ __('Directory Content')}}</strong>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label>{{ __('Directory Name')}}</label>

                                    <input type="text" value="{!! clean($translation->title_page_name) !!}" placeholder="Directory name" name="title_page_name" class="form-control">
