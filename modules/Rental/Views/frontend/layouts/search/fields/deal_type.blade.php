        ...
        <div class="input-group">
            <div class="property_type main_search_wrap drop-down-input border-0 p-0 form-control">
                ...
                <input type="text"
                       ...
                       placeholder="{{__("Property Rental")}}" style="padding: 18px 30px 0 !important;" readonly/>
                <input type="hidden" name="deal_type" value="{{ url('/property-rental') }}" class="drop-down-input__hidden_field"/>
                </div>
