<div class="bravo_filter navbar-expand-lg navbar-expand-lg-collapse-block">
    ...
    <div id="sidebar" class="navbar-expand-lg navbar-expand-lg-collapse-block collapse">
        ...
        <div class="item pb-4 mb-2">
            @include('Rental::frontend.layouts.search.form-search-vertical')
        </div>
        {{--Map--}}
        <div class="item pb-4 mb-2">
            <a href="{{ route("rental.search",['_layout'=>'map']) }}" class="d-block border border-color-1 rounded-xs">
                <img src="{{ url("/images/map.jpg") }}" alt="" width="100%">
            </a>
        </div>
        <form action="{{url(app_get_locale(false,false,'/').config('space.rental_route_prefix'))}}" class="bravo_form_filter">
