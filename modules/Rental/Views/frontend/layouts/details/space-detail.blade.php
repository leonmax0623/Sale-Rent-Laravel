...
@endif
@include('Rental::frontend.layouts.details.space-attributes')
@include('Rental::frontend.layouts.details.space-faqs')
...
@endif
@include('Rental::frontend.layouts.details.space-video')
