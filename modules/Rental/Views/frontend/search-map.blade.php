...
@section('content')
    <div class="bravo_search_tour bravo_search_space">
        <h1 class="d-none">
            {{setting_item_with_lang("property_rental_page_search_title")}}
        </h1>
        <div class="bravo_form_search_map">
            @include('Rental::frontend.layouts.search-map.form-search-map')
        </div>
        <div class="bravo_search_map {{ setting_item_with_lang("property_rental_layout_map_option",false,"map_left") }}">
            ...
            <div class="results_item">
                @include('Rental::frontend.layouts.search-map.advance-filter')
                <div class="listing_items">
                    @include('Rental::frontend.layouts.search-map.list-item')
                </div>
            </div>
        </div>
    </div>
