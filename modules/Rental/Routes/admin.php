...
Route::get('/','RentalController@index')->name('rental.admin.index');
Route::get('/create','RentalController@create')->name('rental.admin.create');
Route::get('/edit/{id}','RentalController@edit')->name('rental.admin.edit');
Route::post('/store/{id}','RentalController@store')->name('rental.admin.store');
Route::post('/bulkEdit','RentalController@bulkEdit')->name('rental.admin.bulkEdit');
Route::get('/recovery','RentalController@recovery')->name('rental.admin.recovery');
Route::get('/getForSelect2','RentalController@getForSelect2')->name('rental.admin.getForSelect2');
Route::get('/all/getForSelect2','RentalController@getAllForSelect2')->name('rental.admin.all.getForSelect2');
