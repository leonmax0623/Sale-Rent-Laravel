...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Rental::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('Rental::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Rental::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        return view('Rental::admin.terms.detail', $data);
    }
