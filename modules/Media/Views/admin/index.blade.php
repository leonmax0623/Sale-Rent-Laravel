                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-left d-flex align-items-center">
                            ...
                            <div class="filter-item">
                                ...
                                <small><i>{{__("Total")}}: @{{total}} {{__("Photos")}}</i></small>
                        ...
                        <div class="col-right">
                            ...
                            <button class="btn btn-success btn-pick-files">
                                ...
                                <span><i class="fa fa-upload"></i> {{__("Upload New Photo ")}}</span>
                ...
                <div class="browser-actions d-flex justify-content-between flex-shrink-0" v-if="selected.length">
                    ...
                    <div class="col-left" v-show="selected.length">
                        ...
                        <div class="control-remove" v-if="selected && selected.length">
                            ...
                            <button class="btn btn-danger" @click="removeFiles">{{__("Delete Photo")}}</button>

                        </div>

                        <div class="control-info" v-if="selected && selected.length">

                            <div class="count-selected">@{{selected.length}} {{__("Photos Selected")}}</div>

                            <div class="clear-selected" @click="selected=[]"><i>{{__("Cancel Selection")}}</i></div>
