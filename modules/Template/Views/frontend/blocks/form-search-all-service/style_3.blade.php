...
<div id="videoDiv2" style="width:100%; margin:auto; display:block; position: relative;"> 
    <video id="video2" preload="" autoplay="" muted="" playsinline="" loop="" style="width:100%; height:auto">
    <source src="http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4" type="video/webm">
    </video> 
    <div id="videoMessage2" class="styling" style=" position: absolute; top: 0; left: 0; display: flex; flex-direction: column;  justify-content: center; align-items: center;  width: 100%; height: 100%;">
        <div class="bravo-form-search-all hero-block hero-v1 text-center z-index-2">
