...
use Modules\Sale\Models\SaleTerm;
...

{
    ...
    public function sale(){
        ...
        return $this->belongsToMany(Sale::class, SaleTerm::getTableName(),'term_id','target_id');

    }

    public function rental(){

        return $this->belongsToMany(Rental::class,RentalTerm::getTableName(),'term_id','target_id');
