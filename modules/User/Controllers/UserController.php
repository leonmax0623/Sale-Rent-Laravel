...
class UserController extends FrontendController
{
    ...
    public function profileUpdate(Request $request){
        ...
        $input['phone_code'] = $input['hidden_phone_code'];
        $user->fill($input);
    ...
    public function userRegister(Request $request)
    {
        ...
        $messages = [
            'phone_code'      => __('Phone Code is required field'),
            'phone_without_code.required'      => __('Phone is required field'),
        ...
        if ($validator->fails()) {
            ...
            $user = \App\User::create([
                ...
                'email'      => $request->input('email'),
                'email_is_verified' => 0,
                'email_verify_code' => (string)Str::uuid(),
                'password'   => Hash::make($request->input('password')),
                'status'    => $request->input('publish','publish'),
                'phone'    => $request->input('phone'),
                'phone_without_code'    => $request->input('phone_without_code'),
