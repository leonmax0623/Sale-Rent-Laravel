...
@section('content')
    ...
    <form action="{{route('user.profile.update')}}" method="post" class="input-has-icon">
        ...
        @csrf
        <input id="register_phone_country" type="hidden" name="phone_country" value="{{old('phone_country',$dataUser->phone_country)}}">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="hidden" value="{{old('phone_code',$dataUser->phone_code)}}" name="phone_code" placeholder="{{__("Phone Code")}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                ...
                                <span class="btn btn-default btn-file">
                                    ...
                                    {{__("Browse")}}… <input type="file" data-value="avatar">
