...
@section('content')
    <form action="{{url('admin/module/user/store/'.($row->id ?? -1))}}" method="post" class="needs-validation" novalidate>
        @csrf
        <input id="register_phone_country" type="hidden" name="phone_country" value="{{old('phone_country',$row->phone_country)}}">
        <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="register_phone_code" type="text" value="" name="hidden_phone_code" placeholder="{{__("Phone Code")}}" class="form-control">
                                                <input id="register_hidden_phone_code" type="hidden" value="{{old('phone_code',$row->phone_code)}}" name="phone_code" placeholder="{{__("Phone Code")}}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>{{__("Phone Number")}}</label>
                                                <input type="text" value="{{old('phone',$row->phone)}}" name="phone" placeholder="{{__("Phone Number")}}" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
