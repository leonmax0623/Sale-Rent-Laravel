                ...
                <div class="form-controls">
                    ...
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            ...
                            @foreach($flight_search_fields as $key=>$item)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                ...
                                                @foreach($languages as $language)
                                                    ...
                                                    <div class="g-lang">
                                                        ...
                                                        <input type="text" name="flight_search_fields[{{$key}}][title{{$key_lang}}]" value="{{$item['title'.$key_lang] ?? ''}}" class="form-control">
                                            ...
                                            @else
                                                ...
                                                <input type="text" name="flight_search_fields[{{$key}}][title]" value="{{$item['title']}}" class="form-control">

                                            @endif

                                            <select name="flight_search_fields[{{$key}}][field]" class="custom-select">
                                            ...
                                            <select name="flight_search_fields[{{$key}}][size]" class="mt-2 custom-select">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" name="flight_search_fields[{{$key}}][position]" min="0" value="{{$item['position'] ?? 0}}" class="form-control">
