...

{
...

    {
        ...
        if ($this->slugFieldName && $this->slugFromFieldName) {
            $slugFieldName = $this->slugFieldName;
            $this->$slugFieldName = $this->generateSlugPage($this->$slugFieldName);
    ...
    public function generateSlugPage($string = false, $count = 0)

    {

        $slugFromFieldName = $this->slugFromFieldName;

        if (empty($string))

            $string = $this->$slugFromFieldName;
